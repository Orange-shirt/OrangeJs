...
function DoTask() {
    ...
    while (true) {
        ...
        if (i >= List.childCount()) {
            ...
            if (RwTitle.search("邀请好友") < 0 && RwTitle.search("开通省钱卡") < 0 && RwTitle.search("天猫农场") < 0 && RwTitle.search("续费88VIP") < 0 && RwTitle.search("淘宝人") < 0&& RwTitle.search("收菜") < 0 && RwTitle.search("红包省钱卡") < 0  && RwTitle.search("开连续包月") < 0 && now != xz) {
