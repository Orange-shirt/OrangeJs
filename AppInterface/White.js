...
function mainUi() {
    ...
    ui.layout(
        <ScrollView>
            <frame w="*" h="*" id="main" background="{{context_framebg}}">//全局背景颜色
        ...
        <linear orientation="horizontal" align="center" margin="5">
            ...
            <text id="AboutApp" text="关于软件" color="#BDBDBD" margin="10 70 0 0" bg="{{context_textBg}}" gravity="center" textSize="12sp"/>
        </linear>
        </vertical>
        </frame>
        </ScrollView>
