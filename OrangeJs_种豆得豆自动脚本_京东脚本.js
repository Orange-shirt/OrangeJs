...
function DoTask() {
    ...
    if (className("android.widget.TextView").text("培养").findOnce() != null) {
        ...
        if (B != null && B.child(0).childCount() == 2) { //关注任务
        ...
        } else if (B != null && B.child(0).childCount() != 2) {
        ...
        if (B.child(4).child(0)!= null && B.child(4).child(0).childCount() ==2||B.child(4).child(0)!= null && B.child(4).child(0).childCount() >2&& B.child(4).child(0).child(1).child(0).className() != "android.widget.ImageView") {
            let a = B.child(4).bounds(); //更多任务按钮
            click(a.centerX(), a.centerY());
