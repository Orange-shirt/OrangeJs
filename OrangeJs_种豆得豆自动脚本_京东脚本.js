                    ...
                    while (true) {
                        ...
                        if (over >= limit) {
                            ...
                            if (Now != i) {
                                ...
                                if (C.child(0).child(0).child(2).child(0).child(0).child(0).childCount() == 5) {
                                    let d = C.child(0).child(0).child(2).child(0).child(0).child(0).child(4).child(0).child(0).bounds();
                                    click(d.centerX(), d.centerY());
                                } else if (C.child(0).child(0).child(2).child(0).child(0).child(0).childCount() == 4) {
                                    let d = C.child(0).child(0).child(2).child(0).child(0).child(0).child(3).child(0).child(0).bounds();
                                    click(d.centerX(), d.centerY());
                                }
