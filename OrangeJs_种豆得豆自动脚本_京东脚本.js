    ...
    let w = floaty.rawWindow(
        <card bg="#80000000">
            <vertical align="center">
                ...
                <com.stardust.autojs.core.console.ConsoleView id="ConS" margin="0"/>
            </vertical>
        </card>
    );
...
function DoTask() {
    ...
    if (id("com.jingdong.app.mall:id/fd").text("种豆得豆").findOnce() != null && className("android.view.View").text("培养").findOnce() != null) {
        ...
        if (B != null && B.child(0).child(0).child(0).childCount() == 2 || B != null && B.child(0).child(0).child(0).childCount() == 3 && B.child(0).child(0).child(0).child(2).text() == "x1") { //每日签到任务
