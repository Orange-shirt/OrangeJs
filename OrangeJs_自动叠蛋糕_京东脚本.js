...
function DoTask() {
    ...
    if (makesureHDTC() == true) {
        ...
        while (true) {
            ...
            if (a >= B.childCount()) {
                toastLog("当前所有任务已完成");
                var B = className("android.view.View").text("做任务领金币").findOne().parent().parent().parent().parent().child(4).child(0).child(0).child(0).child(1).child(0);
                ...
                if (a.clickable() == true) {
                    ...
                    sleep(2000);
                    if (className("android.view.View").text("暂时离开").findOnce() != null) {
                        dialogs.alert("ffg");
                    }
                } else {
                    let b = a.bounds();
